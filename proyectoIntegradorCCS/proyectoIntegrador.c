...
#fuses NOWDT      // Reset de perro guardián desactivado 
...
#fuses NOLVP      // No Bajo voltaje de programación en B3(PIC16)
#fuses NODEBUG    // No modo Debug para ICD (In Circuit Debug)
#define sAN0 1    // | A0
#use delay(clock = 8MHz)                         // Frecuencia final de reloj
#include <stdlib.h>
#use rs232(baud = 9600, xmit= PIN_C6, rcv=PIN_C7,stream=receptor) // Inicializa comunicación UART, para Debugguear
